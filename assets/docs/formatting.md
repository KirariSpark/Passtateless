...
![resource:assets/docs/imgs/formatting/indicator.png](assets/docs/imgs/formatting/indicator.png)

如图所示，你可以注意到不同的部分被标上了不同的颜色，它可以帮助你分清层级。而左侧的小三角则是折叠标记，点击它可以折叠或展开代码片段。